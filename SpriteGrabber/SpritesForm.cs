...
namespace SpriteGrabber
{
    public partial class SpritesForm : Form
    {
        ...
        public SpritesForm(MainForm parent, List<Bitmap> sprites) : this()
        {
            ...
            pbSprite.BackgroundImage = mainForm.createChecker(pbSprite.Width, pbSprite.Height, SpriteGrabber.Properties.Settings.Default.CheckerTileWidth, Color.LightGray, Color.WhiteSmoke);
